                    ...
                    <div className={styles.containerInput}>
                        ...
                        <div>
                            <input type="Email" placeholder='Email' className={styles.inputEmail}
                                   onChange={handleChange} required ref={emailRef}/>
                            {error && (<p className={styles.errorEmail}>Check the email please.</p>)}
                        </div>
                    </div>
                    <textarea name="" placeholder='Subject and description.' ref={subjectRef} id="SubjectUser" cols={30}
                              rows={10} className={styles.textarea} required></textarea>
                    <button ref={submitRef} type="submit" value="Submit" disabled={sending}
